					...
					<div class="tab-content">
						<div class="tab-pane active" id="A">
							<fieldset>
								...
								<div class="control-group">
									<label class="control-label">销售热线</label>
									<div class="controls">
										<input type="text" name="options[site_admin_telephone]" value="<?php echo ($site_admin_telephone); ?>">
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">国际销售热线</label>
									<div class="controls">
										<input type="text" name="options[site_admin_english_telephone]" value="<?php echo ($site_admin_english_telephone); ?>">
									</div>
								</div>
								<div class="control-group">
