...
<head>
	...
	<![endif]-->
	<title>EmpireChem - Campus Internships</title>
	<!--bootstrap-->
...
<!-- 						<div class="tr col-sm-2">
						...
						<div class="col-sm-10">
							<form method="post" action="<?php echo U('portal/campusrecruit/campusrecruit');?>" class="js-ajax-form form-inline clearfix">
								<input type="text" id="keywords" name="keywords" class="filterSearch padding5 form-control" placeholder="Keywords">
								<input type="submit" class="filterSubmit js-ajax-submit btn btn-warning" value="Search">
							</form>
						</div> -->
					</div>
				</div>
<!-- 				<div class="text marginTop35">
					<div class="table-responsive">
						<table class="recruit-table table table-hover">
							...
							<tbody>
								<?php if(is_array($campusrecruitData)): foreach($campusrecruitData as $key=>$vo): ?><tr data-toggle="modal" data-target="#ad<?php echo ($vo["id"]); ?>" >
				...
				<?php if(is_array($campusrecruitData)): foreach($campusrecruitData as $key=>$co): ?><div class="modal fade" id="ad<?php echo ($co["id"]); ?>">
			...
			<div class="col-sm-2">
				<ul class="jyzp-ul nav mt35 padding10">
					...
					<li><a href="<?php echo U('portal/Recurit/recurit_en');?>">Job Search</a></li>
					<li><a href="<?php echo U('portal/professional/index_en');?>">Opportunities for Talents</a></li>
					<li><a class="xyzp-li" href="<?php echo U('portal/Campusrecruit/campusrecruit_en');?>">Campus Internships</a></li>
				</ul>
			</div>
		</div>
	</div>
