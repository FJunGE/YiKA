...
<head>
	...
	<![endif]-->
	<title>EmpireChem - Career Development</title>
	<!--bootstrap-->
	...
	<div class="banner">
		<div class="content">
			<div class="container">
				...
				<p>We need professionals and encourage employees to develop their capacity. At EmpireChem, employees come together in interdisciplinary and global teams to realize exciting projects. We provide internal meetings to let our employees to communicate with their superior for performance and efficiency, then to better know different department duties and company culture. You are entrusted with customized goals to enhance your potential ability.</p>
			</div>
		</div>
	</div>
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-2">
				<ul class="jyzp-ul nav padding10 mt40">
					...
					<li><a class="zyfz-li" href="<?php echo U('portal/Zydevelopment/index_en');?>">Career Development</a></li>
					<li><a href="<?php echo U('portal/Recurit/recurit_en');?>">Job Search</a></li>
					<li><a href="<?php echo U('portal/professional/index_en');?>">Opportunities for Talents</a></li>
					<li><a href="<?php echo U('portal/Campusrecruit/campusrecruit');?>">Campus Internships</a></li>
				</ul>
			</div>
		</div>
	</div>
